...
def main():
    """
    Основная цель игры: угадать случайное слово из заданного списка.
    Игроку будет предложано угадать слово и он будет получать подсказки о правильности своего выбора.
    """

common_nouns = ["время","человек", "год","дело","день","рука","раз","город","слово","место","лицо","друг","глаз","вопрос","дом","сторона","страна","мир","случай",
"голова","ребёнок","сила","конец","вид","система","часть","работа","жизнь","власть","женщина","дорога","образ","отец","история","нога","вода","война","любовь","минута",
"право","небо","сын", "душа","утро","вечер","месяц","комната","ночь","мать","утро","вещь","цель","народ","сердце","шаг","девушка","машина","уровень","окно","ответ",
"условие","начало","свет","действие","век","школа","газета","плечо","путь","дверь","язык","любовь","порядок","автор","гость","закон","число","идея","смерть","сон",
"ресурс","лес","проблема","искусство","река","проект","журнал","стена","товарищ","книга","письмо","помощь","группа","участие",]

answer = list(random.choice(common_nouns))

playfield = ["_" for _ in answer]
guesses = []
attempts = 6
...
while True:
    ...
    guess = list(input("Введите одну букву: ")) 
    for i in range(len(answer)):
        if guess in answer:
            playfield = colorize("position", guess)
        elif guess not in answer:
            playfield = colorize("letter", guess)
